...
result_no_divishion_loss = item_1 // item_2
# Вывести result_no_division_loss в консоль.
print(result_no_divishion_loss)
...
#b_item_result_divishion = b_item_t / b_item_f
# Вывести b_item_relult_division в консоль. (Получить ошибку)
#print(b_item_result_divishion)
...
print(b_item_1_int)
# Создать переменную b_item_2_int и присвоить явное приведение b_item_2 к int (опечатка??? вместо 2 должно быть f?)
